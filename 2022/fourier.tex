...
\pagebreak
\item The Fourier cosine series of a function is given by: $f(x) = \sum_{n=0}^{\infty} f_{n}\cos{nx}$. For $f(x) = \cos^{4}x$, the numerical value of $(f_{4} + f_{5})$ is \\
\hfill{GATE CE 2022} \\
\solution \\
\input{2022/CE/30/1.tex}
\pagebreak
\end{enumerate}
